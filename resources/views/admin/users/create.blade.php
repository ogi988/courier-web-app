                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.users.store') }}">
                            @csrf
                            <div>
                                <p>Izaberite koji tip korisnika dodajete:</p>
                            </div>
                            <div class="form-check">

                                <input class="form-check-input" id="1" type="radio" name="izbor" value="1">
                                <label for="1" class="form-check-label">Admin</label><br>

                                <input class="form-check-input" id="2" type="radio" name="izbor" value="2">
                                <label for="2" class="form-check-label">Worker</label><br>

                                <input class="form-check-input" id="3" type="radio" name="izbor" value="3">
                                <label for="3" class="form-check-label">User</label><br>
                            ...
                            <div class="form-group row">
                                <label for="bank_acc" class="col-md-4 col-form-label text-md-right">{{ __('Bankovni racun') }}</label>

                                <div class="col-md-6">
                                    <input id="bank_acc" type="number" class="form-control @error('bank_acc') is-invalid @enderror" name="bank_acc" value="{{ old('bank_acc') }}" autocomplete="bank_acc" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Potvrdite Password') }}</label>
