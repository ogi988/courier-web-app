        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.shipments.update', $shipment_edit->id) }}">
                            @csrf
                            {{ method_field('PUT') }}
                            ...
                            <div class="form-check align-content-center">
                                ...
                                @if($shipment_edit->type === 'Fizicko lice'){{ 'checked'}}@endif
                                >
                                ...
                                @if($shipment_edit->type ==='Pravno lice'){{ 'checked'}}@endif
                                >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$shipment_edit->name}}" autocomplete="name" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{$shipment_edit->surname}}" autocomplete="surname" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{$shipment_edit->address}}" autocomplete="address" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{$shipment_edit->city}}" autocomplete="city" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="number" type="number" class="form-control @error('number') is-invalid @enderror" name="number" value="{{$shipment_edit->number}}" autocomplete="number" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$shipment_edit->email}}" autocomplete="email">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="custom-select custom-select-lg mb-3 mass" name="mass" id="mass" >
                                        <option label="do 0.5 kg" value="0.5" {{ $shipment_edit->mass == 0.5 ? 'selected' : '' }} >do 0.5 kg</option>
                                        <option label="do 1 kg" value="1" {{ $shipment_edit->mass == 1 ? 'selected' : '' }}>do 1 kg</option>
                                        <option label="do 2 kg" value="2" {{ $shipment_edit->mass == 2 ? 'selected' : '' }}>do 2 kg</option>
                                        <option label="do 5 kg" value="5" {{ $shipment_edit->mass == 5 ? 'selected' : '' }}>do 5 kg</option>
                                        <option label="do 10 kg" value="10" {{ $shipment_edit->mass == 10 ? 'selected' : '' }}>do 10 kg</option>
                                        <option label="do 15 kg" value="15" {{ $shipment_edit->mass == 15 ? 'selected' : '' }}>do 15 kg</option>
                                        <option label="do 20 kg" value="20" {{ $shipment_edit->mass == 20 ? 'selected' : '' }}>do 20 kg</option>
                                        <option label="do 30 kg" value="30" {{ $shipment_edit->mass == 30 ? 'selected' : '' }}>do 30 kg</option>
                                        <option label="do 50 kg" value="50" {{ $shipment_edit->mass == 50 ? 'selected' : '' }}>do 50 kg</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="shipment_price" type="number" class="form-control @error('shipent_price') is-invalid @enderror" name="shipment_price" value="{{$shipment_edit->shipment_price}}" autocomplete="number" >
                            ...
                            <div class="form-check align-content-center">
                                ...
                                @if($shipment_edit->type == 'Posiljalac'){{ 'checked'}}@endif                                
                                >
                                ...
                                @if($shipment_edit->type == 'Primalac'){{ 'checked'}}@endif                                
                                >
